...
const Header = () => {
  ...
  return (
    <div className={`fixed top-0  left-0 w-full z-50\
     border-b border-n-6 lg:border-n-8/90 lg:backdrop-blur-sm
     ${openNavigation?"bg-n-8":"bg-n-8/90"}  `}>
        ...
        max-lg:py-4">
            ...
            lg:flex lg:mx-auto lg:bg-transparent lg:static
            `}>
               <div className="realtive z-2 flex flex-col items-center
