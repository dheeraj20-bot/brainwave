  ...
  return (
    <Section crosses>
         <div className='container lg:flex'>
            ...
            <div className='lg:ml-auto xl-[38rem] mt-4'>
                 <p className='body-2 mb-4 text-n-4 md:mb-16
                 lg:mb-24 lg:w-[22rem] lg:mx-auto'>{collabText}</p>

                 <div className='relative left-1/2 flex w-[22rem]
                   aspect-square rounded-full -translate-x-1/2 border border-n-6 scale-75
                  md:scale-100'>
                            ...
                            collabApps.map((app,index)=>(
                                <li key={app.id} className={` absolute top-0 left-1/2
                                 h-1/2 -ml-[1.6rem]  origin-bottom  rotate-${index *45}`}>
                                   ...
                                   <div className={`relative  -top-[1.6rem] flex rounded-xl  w-[3.2rem] h-[3.2rem]
                                    bg-n-7 border border-n-1/15
                                     -rotate-${index*45}`}>
                                    <img className='m-auto  animate-bounce ' width={app.width} height={app.height}
                                    src={app.icon} alt="" />
                                   </div>
                                </li>
                            ))
